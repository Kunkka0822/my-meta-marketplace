        ...
        <>
          <div className="flex flex-col justify-center">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-gray-500 md:text-[16px] text-[14px]">
                # {data.id}
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-end">
              <div className="flex flex-col">
                <div className="flex gap-2 items-center">
                  ...
                  <p className="md:text-[22px] text-[18px] font-[600]">
                    {data.price} MMC
                  </p>
                </div>
                <p className="md:text-[18px] text-[16px]">
                  ≈ {data.price * 0.001} USD
                </p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 border-[1px] border-gray-200 p-4 md:m-3 m-0 mb-[20px] rounded-lg">
              <div className="flex flex-col">
                ...
                <p className="text-[12px] text-darkgreen rounded-full border-green border-[1px] py-1 px-2 w-fit">
                  alpha
                </p>
              </div>
              <div className="flex flex-col">
